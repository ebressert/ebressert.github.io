...
##Summary##
If you apply the methods we covered above in your code you will get a significant speed up. Not all the problems you will run into are going to be plug-and-play, so you will have to creative at times. If anyone has comments or suggestions on other simple speed ups let us know through the comments :-).  
